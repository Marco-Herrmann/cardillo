...
from cardillo.solver import Newton, SolverOptions, Solution
...
def helix(
    ...
    *,
    ...
    if VTK_export:
        vtk_name = f"vtk/slen_{slenderness:1.0e}/{save_name}{'_u' if updated else ''}"
        system.export(dir_name, vtk_name, sol)
        sol_steps = Solution(sol.system, t=sol.all_t, q=sol.all_q)
        system.export(dir_name, f"{vtk_name}_steps", sol_steps)
